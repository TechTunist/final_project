...
char hostName[MAX_HOST_LEN] = "Office Node"; // Default Host name
//char ST_SSID[MAX_HOST_LEN]  = ""; //Default router ssid
//char ST_Pass[MAX_PWD_LEN] = ""; //Default router passd

// Home WiFI
//char ST_SSID[MAX_HOST_LEN]  = "SKYXIENC"; //Default router ssid
//char ST_Pass[MAX_PWD_LEN] = "7GQiqMQT6zdB"; //Default router passd

// Office WiFi
 char ST_SSID[MAX_HOST_LEN]  = "TP-Link_9958"; //Default router ssid
 char ST_Pass[MAX_PWD_LEN] = "15295316"; //Default router passd
